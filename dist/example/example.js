...
/***/ (function(module, exports, __webpack_require__) {
	...
	_util2.default.fn.scroll = function (options) {
	    ...
	    var pickerItem = document.querySelector('.weui-picker__indicator');
	    var rowHeight = document.defaultView.getComputedStyle(pickerItem)['height'].replace(/px/gi, '');
	    var defaults = _util2.default.extend({
	        items: [], // 数据
	        ...
	        bodyHeight: 7 * rowHeight // picker的高度，用于辅助点击滚动的计算
	    }, options);
