...
| [options.cron] | <code>string</code> | <code>&quot;* * *&quot;</code>  &#124; `false` | cron 表达式，三位，分别是 dayOfMonth[1-31]，month[1-12] 和 dayOfWeek[0-6]（周日-周六）；设置为 `false` 时，忽略之（优化在 Safari 中 时间间隔大于100年时弹出过慢的问题） |
| [options.className] | <code>string</code> |  | 自定义类名 |
